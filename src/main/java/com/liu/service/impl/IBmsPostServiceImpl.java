...
/*创建列表*/
    ...
    public BmsPost create(CreateTopicDTO dto, UmsUser user) {
        //判断下列表是否包含该话题，返回
        BmsPost topic1 = this.baseMapper.selectOne(new LambdaQueryWrapper<BmsPost>()
    ...
    public Map<String, Object> viewTopic(String id) {
        ...
        for (BmsTopicTag articleTag : iBmsTopicTagService.list(wrapper)) {
            ...
            System.out.println(articleTag.getTagId() +"刘淼");
        }
        List<BmsTag> tags = iBmsTagService.listByIds(set);
        System.out.println(tags +"刘淼");
        map.put("tags", tags);
